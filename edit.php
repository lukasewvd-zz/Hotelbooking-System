...
<html>
    ...
    <body>
        ...
        <form id="f" action="backend_update.php" style="padding:20px;">
            ...
            <div><input type="text" id="phoneNumber" name="phoneNumber" value="<?php print $reservation['phoneNumber'] ?>" /></div>
            <div>Adults:</div>
            <div>
            ...
            <div><textarea rows="4" cols="50" type="text" id="note" name="note"><?php print $reservation['note'] ?></textarea></div>
            <div>Status:</div>
            <div>
